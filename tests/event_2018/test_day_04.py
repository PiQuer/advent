...
round_1 = dataset_parametrization("2018", "04", examples=[("", 240)], result=143415, dataset_class=DataSet)
round_2 = dataset_parametrization("2018", "04", examples=[("", 4455)], result=49944, dataset_class=DataSet)
