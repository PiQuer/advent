...
round_1 = dataset_parametrization(day="02", examples=[("", 2)], result=638, dataset_class=DataSet)
round_2 = dataset_parametrization(day="02", examples=[], result=699, dataset_class=DataSet)
