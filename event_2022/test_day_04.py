...
round_1 = dataset_parametrization("04", examples=[("", 2)], result=534, dataset_class=DataSet)
round_2 = dataset_parametrization("04", examples=[("", 4)], result=841, dataset_class=DataSet)
