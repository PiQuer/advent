...
round_1 = dataset_parametrization(day="04", examples=[("", 1514)], result=361724, dataset_class=DataSet)
round_2 = dataset_parametrization(day="04", examples=[], result=482, dataset_class=DataSet)
