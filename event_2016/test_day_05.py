...
round_1 = dataset_parametrization(day="05", examples=[("", "18f47a30")], result="4543c154", dataset_class=DataSet)
round_2 = dataset_parametrization(day="05", examples=[("", "05ace8e3")], result="1050cbbd", dataset_class=DataSet)
