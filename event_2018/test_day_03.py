...
round_1 = dataset_parametrization("03", examples=[("", 4)], result=118322, dataset_class=DataSet)
round_2 = dataset_parametrization("03", examples=[("", 3)], result=1178, dataset_class=DataSet)
